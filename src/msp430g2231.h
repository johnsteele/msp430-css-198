...
#define SREF_0              (0U*0x2000)  /* VR+ = AVCC and VR- = AVSS */
#define SREF_1              (1U*0x2000)  /* VR+ = VREF+ and VR- = AVSS */
#define SREF_2              (2U*0x2000)  /* VR+ = VEREF+ and VR- = AVSS */
#define SREF_3              (3U*0x2000)  /* VR+ = VEREF+ and VR- = AVSS */
#define SREF_4              (4U*0x2000)  /* VR+ = AVCC and VR- = VREF-/VEREF- */
#define SREF_5              (5U*0x2000)  /* VR+ = VREF+ and VR- = VREF-/VEREF- */
#define SREF_6              (6U*0x2000)  /* VR+ = VEREF+ and VR- = VREF-/VEREF- */
#define SREF_7              (7U*0x2000)  /* VR+ = VEREF+ and VR- = VREF-/VEREF- */
...
#define INCH_0              (0U*0x1000)  /* Selects Channel 0 */
#define INCH_1              (1U*0x1000)  /* Selects Channel 1 */
#define INCH_2              (2U*0x1000)  /* Selects Channel 2 */
#define INCH_3              (3U*0x1000)  /* Selects Channel 3 */
#define INCH_4              (4U*0x1000)  /* Selects Channel 4 */
#define INCH_5              (5U*0x1000)  /* Selects Channel 5 */
#define INCH_6              (6U*0x1000)  /* Selects Channel 6 */
#define INCH_7              (7U*0x1000)  /* Selects Channel 7 */
#define INCH_8              (8U*0x1000)  /* Selects Channel 8 */
#define INCH_9              (9U*0x1000)  /* Selects Channel 9 */
#define INCH_10             (10U*0x1000) /* Selects Channel 10 */
#define INCH_11             (11U*0x1000) /* Selects Channel 11 */
#define INCH_12             (12U*0x1000) /* Selects Channel 12 */
#define INCH_13             (13U*0x1000) /* Selects Channel 13 */
#define INCH_14             (14U*0x1000) /* Selects Channel 14 */
#define INCH_15             (15U*0x1000) /* Selects Channel 15 */
